...
parser.add_argument('-i', metavar='in-file', type=str, default="/hr4e/templates/hr4e_patient_template.xml")
parser.add_argument('-g', metavar='green-out-file', type=str, default="/hr4e/templates/green_patient_template.xml")
parser.add_argument('-c', metavar='cda-out-file', type=str, default="/hr4e/templates/cda_patient_template.xml")
parser.add_argument('-hxslt', metavar='hr4e-xslt-file', type=str, default="/hr4e/templates/hr4e_patient_to_ccd.xslt")
parser.add_argument('-gxslt', metavar='green-xslt-file', type=str, default="/hr4e/templates/green_ccd.xslt")
...
command = "java -jar /hr4e/templates/saxon/saxon9he.jar " + " -s:" + input + " -xsl:" + hr4e_xslt + " > " + green_output
print command
...
command = "java -jar /hr4e/templates/saxon/saxon9he.jar " + " -s:" + green_output + " -xsl:" + green_xslt + " > " + cda_output
print command
